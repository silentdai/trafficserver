...
static void extractConfigInfo(const char *mgmt_path, const char *recs_conf, char *userName, int *fds_throttle);
...
//
void
extractConfigInfo(const char *mgmt_path, const char *recs_conf, char *userName, int *fds_throttle)
{
  char file[1024];
